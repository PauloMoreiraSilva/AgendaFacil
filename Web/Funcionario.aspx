<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Funcionario.aspx.cs" Inherits="PI4Sem.AgendaFacil.Funcionario" MasterPageFile="~/MenuMain.master" Theme="PI4SemTheme" %>
...
<asp:Content ID="ContentPage" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenAdd() {
            window.location = "FuncionarioAdd.aspx";
        }

        function OpenEdit(IdEmpresa, IdFuncionario) {
            window.location = "FuncionarioEdit.aspx?IdEmpresa="+IdEmpresa+"&IdFuncionario=" + IdFuncionario;
        }
    </script>
