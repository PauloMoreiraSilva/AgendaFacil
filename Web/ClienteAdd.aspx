<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClienteAdd.aspx.cs" Inherits="PI4Sem.AgendaFacil.ClienteAdd" MasterPageFile="~/MenuMain.master" Theme="PI4SemTheme" %>
                            ...
                            <form id="form1" runat="server" class="form-horizontal">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txtObs" runat="server" CssClass="form-control" Text="" MaxLength="8" placeholder="Observações:" />
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
