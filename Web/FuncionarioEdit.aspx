<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FuncionarioEdit.aspx.cs" Inherits="PI4Sem.AgendaFacil.FuncionarioEdit" MasterPageFile="~/MenuMain.master" Theme="PI4SemTheme" %>
                        ...
                        <div class="card card-info">
                            ...
                            <form id="form1" runat="server" class="form-horizontal">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="display:none">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Informe se é o proprietário da Empresa" ControlToValidate="cboProprietario">*</asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <!-- /.card-body -->
