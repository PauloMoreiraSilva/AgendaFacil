<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Usuario.aspx.cs" Inherits="PI4Sem.AgendaFacil.Usuario" MasterPageFile="~/MenuMain.master" Theme="PI4SemTheme" %>
...
<asp:Content ID="ContentPage" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenAdd() {
            window.location = "UsuarioAdd.aspx";
        }

        function OpenEdit(IdEmpresa, IdFuncionario) {
            window.location = "UsuarioEdit.aspx?IdEmpresa=" + IdEmpresa + "&IdFuncionario=" + IdFuncionario;
        }
    </script>
