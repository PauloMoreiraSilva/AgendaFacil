<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EsqueciUsuario.aspx.cs" Inherits="PI4Sem.AgendaFacil.EsqueciUsuario" Theme="PI4SemTheme" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table border="0" cellpadding="2" cellspacing="2" width="45%" style="margin-left: auto; margin-right: auto; border: solid 1px #002258;">
                <tr>
                    <td align="center" style="font-weight: bold" colspan="2">Solicitando nomes de usuários
                    </td>
                </tr>
                <tr>
                    <td align="center" class="ButtonTD" colspan="2">&nbsp;<asp:Button ID="btnSalvar" runat="server" Text="Solicitar" CssClass="Button" OnClick="BtnSalvar_Click" />
